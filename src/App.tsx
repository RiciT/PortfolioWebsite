...
const App = () => {
  ...
  const myProjects = [
    { title: 'Cobble Compiler', description: '', tech: ['C++', 'CMake', 'Assembly', 'Nasm'], image: '🛒', link: "https://github.com/RiciT/Cobble_Compiler" },
    { title: 'Cobble Web Editor', description: '', tech: ['ReactJS', 'TypeScript', 'Node.js', 'ExpressJS','Docker', 'Monaco Editor'], image: '💪', link: "https://github.com/RiciT/Cobble_WebEditor"},
    { title: 'ChordsFinder', description: '', tech: ['C#', 'MIDI'], image: '💪', link: "https://github.com/RiciT/ChordsFinder" },
    { title: 'Project Intelligent Systems', description: '', tech: ['Python', 'SKLearn'], image: '💪', link: "https://github.com/RiciT/Project-Intelligent-Systems"},
    { title: 'HB Application', description: '', tech: ['Flutter', 'Dart', 'Firebase', 'Swift'], image: '💪', link: "https://github.com/RiciT/HbApp" },
    { title: 'Ludum Dare 58 - Blood and Bounty', description: '', tech: ['Unity', 'C#', 'WebGL', 'HLSL'], image: '📊', link: "https://github.com/RiciT/LudumDare58" },
    { title: 'Multiple Unkown Equations Solver with Determinants', description: '', tech: ['C#'], image: '💪', link: "https://github.com/RiciT/MultipleUnknownEquationSolver_determinants" },
    { title: 'Ludum Dare 56 - Rat Dead Redemption', description: '', tech: ['Unity3D', 'C#', 'WebGL', 'HLSL'], image: '🤖', link: "https://github.com/RiciT/LudumDare56" },
    { title: 'Alpha-Stirling Engine Simulation', description: '', tech: ['C#'], image: '💪', link: "https://github.com/RiciT/Stirling" },
    { title: 'Ludum Dare 54 - Void Hunter', description: '', tech: ['Unity', 'C#', 'WebGL'], image: '📊', link: "https://github.com/RiciT/Void-Hunter" },
    { title: 'TicTacToe', description: '', tech: ['Processing', 'Java'], image: '💪', link: "https://github.com/RiciT/TicTacToe" },
    { title: 'Online class attender', description: '', tech: ['C#', 'Google API'], image: '💪', link: "https://github.com/RiciT/suliapp" },
    { title: 'Ludum Dare 50 - Blasty Tag', description: '', tech: ['Unity', 'C#', 'WebGL'], image: '🤖', link: "https://github.com/RiciT/LudumDare50" },
    { title: 'Minesweeper', description: '', tech: ['Processing', 'Java'], image: '💪', link: "https://github.com/RiciT/Minesweeper" },
    { title: 'Game Of Life', description: '', tech: ['Processing', 'Java'], image: '💪', link: "https://github.com/RiciT/GameOfLife" },
    { title: 'SmarTree', description: '', tech: ['C#', 'Firebase', 'Node.js'], image: '💪', link: "https://github.com/RiciT/SmarTree" },
    { title: '3D Shooter Game', description: '', tech: ['Unity3D', 'C#'], image: '💪', link: "https://github.com/RiciT/3DShooterGame" },
    { title: 'Ludum Dare 45 - The Seven', description: '', tech: ['Unity', 'C#'], image: '📊', link: "https://github.com/RiciT/LudumDare45" },
  ];
  //#endregion
